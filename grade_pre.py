...
for folder in os.listdir(base_directory):
    ...
    try:
        ...
        student_tag = student_folder.split('/')[-1]
        print(f"⛓️ {student_tag} is at commit {commit_hash}")
        ...
        if os.path.exists(wasm_file_path):
            ...
            if os.path.exists("stderr.txt"):
                ...
                with open("stderr.txt", "r") as stderr_file:
                    ...
                    commit_text = "⛓️ {0} is at commit {1}\n \n".format(student_tag, commit_hash)
                    stderr_content = commit_text + stderr_content
        ...
        print(f" 🤯Could not process assignment for {folder} 🤯. Error:\n {e}")
