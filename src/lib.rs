...
//! 	--branch release-crates-io-v1.11.0
//! ```
//!
//! > Note that a released version of this binary will be available soon: <https://github.com/paritytech/polkadot-sdk/issues/4352>
//!
//! ```text
...
//! ```
//!
//! Generates a chain-spec with [`VALUE_KEY`] set to `42 * 2`.
//!
